...
- [4. How to setup Mock Service Worker (MSW)?](#4-how-to-setup-mock-service-worker-msw)
  - [4.1 Install library](#41-install-library)
  - [4.2 Config \& Setup](#42-config--setup)
    - [4.2.1 src/mocks/handlers.ts](#421-srcmockshandlersts)
    - [4.2.2 src/mocks/node.ts](#422-srcmocksnodets)
    - [4.2.3 src/mocks/browser.ts](#423-srcmocksbrowserts)
    - [4.2.4 vitest.setup.ts](#424-vitestsetupts)
  - [4.3 How to mock API for React App?](#43-how-to-mock-api-for-react-app)
  - [4.4 How to mock API for test?](#44-how-to-mock-api-for-test)
...
# 4. How to setup Mock Service Worker (MSW)?
